...
from authaudit.sources import write_normalized_sample


def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Normalize the RBA Kaggle/Zenodo dataset into Privacy-Preserving Authentication Audit "
            "Data Platform login events."
        )
    )
